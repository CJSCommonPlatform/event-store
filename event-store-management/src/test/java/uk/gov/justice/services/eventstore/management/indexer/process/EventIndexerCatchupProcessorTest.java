...
public class EventIndexerCatchupProcessorTest {
    ...
    public void shouldFetchAllMissingEventsAndProcess() throws Exception {
        ...
        final ZonedDateTime indexerCatchupStartedAt = new UtcClock().now();
        final ZonedDateTime indexerCatchupCompetedAt = indexerCatchupStartedAt.plusMinutes(23);
        ...
        when(clock.now()).thenReturn(indexerCatchupStartedAt, indexerCatchupCompetedAt);
