...
public class StreamErrorRepositoryIT {
    ...
    public void shouldSaveAndRemoveErrorsCorrectly() throws Exception {
        ...
        try (final Connection connection = viewStoreDataSource.getConnection()) {
            ...
            streamErrorRepository.save(new StreamError(streamErrorDetails_1, streamErrorHash), connection);
            streamErrorRepository.save(new StreamError(streamErrorDetails_2, streamErrorHash), connection);
        ...
        try (final Connection connection = viewStoreDataSource.getConnection()) {
            ...
            streamErrorRepository.removeErrorForStream(streamId, source, componentName_2, connection);
        ...
        try (final Connection connection = viewStoreDataSource.getConnection()) {
            ...
            streamErrorRepository.removeErrorForStream(streamId, source, componentName_1, connection);
