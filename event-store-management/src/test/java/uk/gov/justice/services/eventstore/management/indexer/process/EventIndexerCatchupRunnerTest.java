...
public class EventIndexerCatchupRunnerTest {
    ...
    public void shouldRunEventCatchupForEachSubscription() throws Exception {
        ...
        inOrder.verify(eventCatchupIndexerByComponentRunner).runEventIndexerCatchupForComponent(subscriptionsDescriptor_1, indexerCatchupRequestedEvent);
        inOrder.verify(eventCatchupIndexerByComponentRunner).runEventIndexerCatchupForComponent(subscriptionsDescriptor_2, indexerCatchupRequestedEvent);
    }
}
