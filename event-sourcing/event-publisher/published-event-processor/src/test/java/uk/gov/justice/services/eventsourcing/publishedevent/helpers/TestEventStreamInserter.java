package uk.gov.justice.services.eventsourcing.publishedevent.helpers;
...
public class TestEventStreamInserter {
    ...
    public void insertIntoEventStream(
            final UUID streamId, final long position_in_stream,
            final boolean active, final ZonedDateTime dateCreated) throws SQLException {
