...
public class EventIndexerCatchupProcessorBeanTest {
    ...
    public void shouldPerformEventCatchup() throws Exception {
        ...
        eventCatchupProcessorBean.performEventIndexerCatchup(subscription, componentName);

        verify(eventCatchupProcessor).performEventIndexerCatchup(subscription, componentName);
    }
}
